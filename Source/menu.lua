...
function Menu.draw()
	...
	elseif Menu.active_panel == "default" then
		...
		love.graphics.rectangle("fill", 150, 250, 50, 50)
		love.graphics.rectangle("fill", 150, 350, 50, 50)
		love.graphics.rectangle("fill", 250, 150, 50, 50)
		love.graphics.rectangle("fill", 250, 250, 50, 50)
		love.graphics.rectangle("fill", 250, 350, 50, 50)
		love.graphics.setColor(255, 100, 100)
		love.graphics.rectangle("fill", 400, 150, 200, 15)
		love.graphics.setColor(100, 255, 100)
		love.graphics.rectangle("fill", 400, 200, 200, 15)
		love.graphics.setColor(255, 255, 255)
